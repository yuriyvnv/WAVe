...
MODELS = [
    ...
    "ANONYMOUS_USER/whisper-tiny-high-mixed-nl", 
    "ANONYMOUS_USER/whisper-tiny-cv-only-nl",
    "ANONYMOUS_USER/whisper-tiny-cv-fully-synthetic-nl"
]
...
def load_datasets():
    """Load multilingual_librispeech datasets for Dutch"""
...
def main():
    ...
    filename = f"whisper_small_multi_eval_nl_{timestamp}.json"
