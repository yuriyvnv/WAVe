...
MODEL_NAME = "whisper-tiny-cv-fully-synthetic-nl"
print(MODEL_NAME)
import json
...
PROJECT_NAME = "whisper-tiny-training-nl"
...
dataset = load_dataset("yuriyvnv/synthetic_transcript_nl", "cv_fully_synthetic",token=HF_TOKEN)
